    ...
    <div class="card p-4" style="max-width:800px">
        <form method="POST" action="{{ route('payment-methods.store') }}">
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="e.g. Cash, MTN Mobile Money, Bank Transfer" required>
            ...
            <button class="btn btn-primary">Save Payment Method</button>
        </form>
    </div>
</x-app-layout>
